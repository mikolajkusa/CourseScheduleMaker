...
public class ScheduleMaker {
    public static void main(String[] args){
        ...
        lib.addCourse(new Course(10200, 30, 4, "Physics", "Spring", "MWF 9-10","PHYS102"));
        lib.addCourse(new Course(11800, 30, 4, "Physics", "Spring", "MWF 10-11","PHYS118"));
        ...
        lib.addCourse(new Course(10500, 30, 6, "Gender Studies", "Spring", "TR 1-2","GS105"));
        lib.addCourse(new Course(31100, 30, 4, "Psychology", "Spring", "TR 9-10","PSYC311"));
        lib.addCourse(new Course(21700, 30, 4, "Botany", "Spring", "MWF 12-1","BOT217"));
