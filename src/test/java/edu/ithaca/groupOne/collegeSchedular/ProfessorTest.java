...
public class ProfessorTest {
    ...
    void changeCreditAmountTest() throws CourseIdInUseException, IllegalArgumentException{
        ...
        prof.createCourse(2, 10, 4, "computer science", "sf2022", "MWF10-1050"); //makes sure semester is tested during course creation
    ...
    void changeSemesterTest() throws CourseIdInUseException, IllegalArgumentException{
        ...
        assertEquals("fa2022", prof.getCourses().get(1).getSemester()); //equivalence case - ignore case
